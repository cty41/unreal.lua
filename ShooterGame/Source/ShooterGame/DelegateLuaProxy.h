...
UCLASS(meta=(Lua=1))
class UDelegate_AShooterAIController_ReceiveMoveCompleted : public UObject{
	GENERATED_BODY()
public:
	TSet<int> LuaCallBacks;
	UDelegate_AShooterAIController_ReceiveMoveCompleted() {};
	using delegatetype = decltype(((AShooterAIController*)0)->ReceiveMoveCompleted);
	void Init(delegatetype& theDelegate){
		UTableUtil::addgcref((UObject*)this);
		theDelegate.AddDynamic(this, &UDelegate_AShooterAIController_ReceiveMoveCompleted::CallBack);
	}
